        ...
        <section className="relative w-full min-h-[600px] flex items-center justify-center bg-slate-900 text-white overflow-hidden">
            ...
            <div className="container relative z-20 px-4 py-32 flex flex-col items-center text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                    ...
                    <Link
                        href="#contact"
                        className="inline-flex h-12 items-center justify-center rounded-md bg-white/10 px-8 text-base font-semibold text-white backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-colors"
                    >
                        Get a Free Quote
                    </Link>
                </div>
